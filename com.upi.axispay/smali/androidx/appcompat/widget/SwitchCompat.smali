...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v2}, Lj3;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    .line 17
    sget-object v7, Lu;->SwitchCompat:[I

    invoke-static {p1, p2, v7, p3, v1}, Lo3;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lo3;

    move-result-object v2

    .line 18
    invoke-virtual {v2}, Lo3;->r()Landroid/content/res/TypedArray;
    ...
    .line 19
    invoke-static/range {v5 .. v11}, Lac;->o0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    .line 20
    sget v4, Lu;->SwitchCompat_android_thumb:I

    invoke-virtual {v2, v4}, Lo3;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 22
    :cond_0
    sget v4, Lu;->SwitchCompat_track:I
    ...
    .line 24
    :cond_1
    sget v4, Lu;->SwitchCompat_android_textOn:I

    invoke-virtual {v2, v4}, Lo3;->p(I)Ljava/lang/CharSequence;
    ...
    .line 25
    sget v4, Lu;->SwitchCompat_android_textOff:I
    ...
    .line 26
    sget v4, Lu;->SwitchCompat_showText:I

    invoke-virtual {v2, v4, v3}, Lo3;->a(IZ)Z
    ...
    .line 27
    sget v4, Lu;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v2, v4, v1}, Lo3;->f(II)I
    ...
    .line 28
    sget v4, Lu;->SwitchCompat_switchMinWidth:I
    ...
    .line 29
    sget v4, Lu;->SwitchCompat_switchPadding:I
    ...
    .line 30
    sget v4, Lu;->SwitchCompat_splitTrack:I

    invoke-virtual {v2, v4, v1}, Lo3;->a(IZ)Z
    ...
    .line 31
    sget v4, Lu;->SwitchCompat_thumbTint:I

    invoke-virtual {v2, v4}, Lo3;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 34
    :cond_2
    sget v4, Lu;->SwitchCompat_thumbTintMode:I

    const/4 v5, -0x1

    .line 35
    invoke-virtual {v2, v4, v5}, Lo3;->k(II)I

    move-result v4

    .line 36
    invoke-static {v4, v0}, Lv2;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 42
    :cond_5
    sget v4, Lu;->SwitchCompat_trackTint:I
    ...
    .line 45
    :cond_6
    sget v4, Lu;->SwitchCompat_trackTintMode:I
    ...
    .line 53
    :cond_9
    sget v0, Lu;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v2, v0, v1}, Lo3;->n(II)I
    ...
    invoke-direct {v0, p0}, Lq2;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Lq2;

    .line 56
    invoke-virtual {v0, p2, p3}, Lq2;->m(Landroid/util/AttributeSet;I)V
...
.method private getThumbScrollRange()I
    ...
    .line 5
    invoke-static {v0}, Lv2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 8
    invoke-static {v6}, Lv2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 24
    invoke-static {v0, v1, v2, v5, v4}, Lo9;->l(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final i()V
    ...
    .line 3
    :cond_0
    invoke-static {p0, v0}, Lac;->H0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public k(Landroid/content/Context;I)V
    ...
    .line 2
    sget p2, Lu;->TextAppearance_android_textColor:I

    invoke-virtual {p1, p2}, Lo3;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 5
    :goto_0
    sget p2, Lu;->TextAppearance_android_textSize:I

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0}, Lo3;->f(II)I
    ...
    .line 9
    :cond_1
    sget p2, Lu;->TextAppearance_android_typeface:I

    const/4 v1, -0x1

    invoke-virtual {p1, p2, v1}, Lo3;->k(II)I

    move-result p2

    .line 10
    sget v2, Lu;->TextAppearance_android_textStyle:I

    invoke-virtual {p1, v2, v1}, Lo3;->k(II)I
    ...
    .line 12
    sget p2, Lu;->TextAppearance_textAllCaps:I

    invoke-virtual {p1, p2, v0}, Lo3;->a(IZ)Z
    ...
    invoke-direct {p2, v0}, Ls0;-><init>(Landroid/content/Context;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 12
    invoke-static {v4}, Lv2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lv2;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
