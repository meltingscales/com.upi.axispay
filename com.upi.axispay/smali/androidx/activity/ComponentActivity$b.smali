...
# virtual methods
.method public f(ILi;Ljava/lang/Object;Lf8;)V
    .locals 8
    ...
    .line 2
    invoke-virtual {p2, v0, p3}, Li;->b(Landroid/content/Context;Ljava/lang/Object;)Li$a;
    ...
    invoke-direct {p3, p0, p1, v1}, Landroidx/activity/ComponentActivity$b$a;-><init>(Landroidx/activity/ComponentActivity$b;ILi$a;)V
    ...
    .line 4
    :cond_0
    invoke-virtual {p2, v0, p3}, Li;->a(Landroid/content/Context;Ljava/lang/Object;)Landroid/content/Intent;
    ...
    .line 12
    :cond_3
    invoke-static {v0, p2, p1}, Ld8;->o(Landroid/app/Activity;[Ljava/lang/String;I)V
    ...
    .line 18
    invoke-static/range {v0 .. v7}, Ld8;->r(Landroid/app/Activity;Landroid/content/IntentSender;ILandroid/content/Intent;IIILandroid/os/Bundle;)V
    :try_end_0
    ...
    .line 20
    :cond_5
    invoke-static {v0, p2, p1, v7}, Ld8;->q(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
    ...
    .line 21
    :cond_6
    invoke-virtual {p4}, Lf8;->a()Landroid/os/Bundle;
