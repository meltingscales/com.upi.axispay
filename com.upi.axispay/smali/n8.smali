...
.method public constructor <init>(Lm8$e;)V
    ...
    iput-object v0, p0, Ln8;->f:Ljava/util/List;
    ...
    iput-object v0, p0, Ln8;->g:Landroid/os/Bundle;

    .line 4
    iput-object p1, p0, Ln8;->c:Lm8$e;

    .line 5
    iget-object v0, p1, Lm8$e;->a:Landroid/content/Context;

    iput-object v0, p0, Ln8;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lm8$e;->a:Landroid/content/Context;

    iget-object v4, p1, Lm8$e;->K:Ljava/lang/String;

    invoke-direct {v2, v3, v4}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v2, p0, Ln8;->b:Landroid/app/Notification$Builder;
    ...
    .line 9
    :goto_0
    iget-object v2, p1, Lm8$e;->S:Landroid/app/Notification;

    .line 10
    iget-object v3, p0, Ln8;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lm8$e;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lm8$e;->e:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lm8$e;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lm8$e;->k:Ljava/lang/CharSequence;
    ...
    iget-object v4, p1, Lm8$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lm8$e;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lm8$e;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lm8$e;->t:I

    iget v9, p1, Lm8$e;->u:I

    iget-boolean v10, p1, Lm8$e;->v:Z
    ...
    .line 29
    iget-object v4, p0, Ln8;->b:Landroid/app/Notification$Builder;
    ...
    .line 30
    iget-object v0, p0, Ln8;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lm8$e;->q:Ljava/lang/CharSequence;
    ...
    .line 34
    invoke-virtual {p0, v8}, Ln8;->b(Lm8$a;)V

    goto :goto_5

    .line 35
    :cond_6
    iget-object v0, p1, Lm8$e;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    .line 36
    iget-object v8, p0, Ln8;->g:Landroid/os/Bundle;
    ...
    .line 38
    iget-boolean v0, p1, Lm8$e;->z:Z

    if-eqz v0, :cond_8

    .line 39
    iget-object v0, p0, Ln8;->g:Landroid/os/Bundle;
    ...
    .line 40
    :cond_8
    iget-object v0, p1, Lm8$e;->w:Ljava/lang/String;
    ...
    :cond_a
    :goto_6
    iget-object v0, p1, Lm8$e;->y:Ljava/lang/String;
    ...
    .line 47
    :cond_b
    iget-object v0, p1, Lm8$e;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Ln8;->d:Landroid/widget/RemoteViews;

    .line 48
    iget-object v0, p1, Lm8$e;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Ln8;->e:Landroid/widget/RemoteViews;
    ...
    .line 50
    iget-object v8, p0, Ln8;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lm8$e;->n:Z
    ...
    .line 51
    iget-object v8, p1, Lm8$e;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Ln8;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lm8$e;->V:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Ln8;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 53
    iget-object v9, p0, Ln8;->g:Landroid/os/Bundle;
    ...
    iget-object v8, p1, Lm8$e;->G:Landroid/app/Notification;
    ...
    .line 66
    iget-object v0, p1, Lm8$e;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Ln8;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lm8$e;->V:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Ln8;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 67
    :cond_10
    iget-object v0, p1, Lm8$e;->V:Ljava/util/ArrayList;
    ...
    .line 71
    :cond_11
    iget-object v0, p1, Lm8$e;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Ln8;->i:Landroid/widget/RemoteViews;

    .line 72
    iget-object v0, p1, Lm8$e;->d:Ljava/util/ArrayList;
    ...
    .line 73
    invoke-virtual {p1}, Lm8$e;->c()Landroid/os/Bundle;
    ...
    .line 77
    :goto_9
    iget-object v11, p1, Lm8$e;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lm8$e;->d:Ljava/util/ArrayList;
    ...
    .line 80
    invoke-static {v12}, Lo8;->b(Lm8$a;)Landroid/os/Bundle;
    ...
    .line 87
    iget-object v3, p1, Lm8$e;->U:Landroid/graphics/drawable/Icon;
    ...
    .line 91
    iget-object v3, p1, Lm8$e;->H:Landroid/widget/RemoteViews;
    ...
    .line 93
    :cond_16
    iget-object v3, p1, Lm8$e;->I:Landroid/widget/RemoteViews;
    ...
    .line 95
    :cond_17
    iget-object v3, p1, Lm8$e;->J:Landroid/widget/RemoteViews;
    ...
    iget-object v9, p1, Lm8$e;->M:Ljava/lang/String;
    ...
    .line 110
    iget-object v7, p0, Ln8;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lp8;->h()Landroid/app/Person;
    ...
    iget-object v7, p1, Lm8$e;->R:Lm8$d;

    .line 114
    invoke-static {v7}, Lm8$d;->c(Lm8$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 117
    :cond_1c
    invoke-virtual {v4}, Lu8;->a()Landroid/content/LocusId;
    ...
    :cond_1d
    :goto_b
    iget-boolean p1, p1, Lm8$e;->T:Z

    if-eqz p1, :cond_20

    .line 119
    iget-object p1, p0, Ln8;->c:Lm8$e;

    iget-boolean p1, p1, Lm8$e;->x:Z
    ...
    .line 122
    :goto_c
    iget-object p1, p0, Ln8;->b:Landroid/app/Notification$Builder;
    ...
    .line 126
    iget-object v2, p0, Ln8;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lm8$e;->w:Ljava/lang/String;
...
.method public static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 2
    invoke-virtual {v0, p0}, Lp4;->addAll(Ljava/util/Collection;)Z

    .line 3
    invoke-virtual {v0, p1}, Lp4;->addAll(Ljava/util/Collection;)Z
...
.method public static g(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-virtual {v1}, Lp8;->g()Ljava/lang/String;
...
.method public final b(Lm8$a;)V
    ...
    .line 13
    invoke-static {v1}, Lq8;->b([Lq8;)[Landroid/app/RemoteInput;
    ...
    .line 30
    iget-object v0, p0, Ln8;->f:Ljava/util/List;

    iget-object v1, p0, Ln8;->b:Landroid/app/Notification$Builder;

    .line 31
    invoke-static {v1, p1}, Lo8;->f(Landroid/app/Notification$Builder;Lm8$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Ln8;->c:Lm8$e;

    iget-object v0, v0, Lm8$e;->p:Lm8$f;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Lm8$f;->b(Ll8;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Lm8$f;->e(Ll8;)Landroid/widget/RemoteViews;
    ...
    .line 4
    :goto_0
    invoke-virtual {p0}, Ln8;->d()Landroid/app/Notification;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Ln8;->c:Lm8$e;

    iget-object v1, v1, Lm8$e;->H:Landroid/widget/RemoteViews;
    ...
    .line 9
    invoke-virtual {v0, p0}, Lm8$f;->d(Ll8;)Landroid/widget/RemoteViews;
    ...
    .line 11
    iget-object v4, p0, Ln8;->c:Lm8$e;

    iget-object v4, v4, Lm8$e;->p:Lm8$f;

    .line 12
    invoke-virtual {v4, p0}, Lm8$f;->f(Ll8;)Landroid/widget/RemoteViews;
    ...
    .line 14
    invoke-static {v2}, Lm8;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 15
    invoke-virtual {v0, v1}, Lm8$f;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    .line 6
    invoke-virtual {p0, v0}, Ln8;->h(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Ln8;->g:Landroid/os/Bundle;
    ...
    .line 11
    iget-object v1, p0, Ln8;->d:Landroid/widget/RemoteViews;
    ...
    .line 13
    :cond_4
    iget-object v1, p0, Ln8;->e:Landroid/widget/RemoteViews;
    ...
    .line 15
    :cond_5
    iget-object v1, p0, Ln8;->i:Landroid/widget/RemoteViews;
    ...
    .line 34
    invoke-static {v0}, Lo8;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 43
    invoke-static {v0}, Lm8;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v4, p0, Ln8;->g:Landroid/os/Bundle;
    ...
    .line 49
    iget-object v1, p0, Ln8;->f:Ljava/util/List;

    .line 50
    invoke-static {v1}, Lo8;->a(Ljava/util/List;)Landroid/util/SparseArray;
...
.method public f()Landroid/content/Context;
    ...
    .line 1
    iget-object v0, p0, Ln8;->a:Landroid/content/Context;
