...
.field private static final INITIAL_LENGTH:I
...
.method public static synthetic access$100(Lio/fabric/sdk/android/services/common/QueueFile;I)I
    .locals 0
...
.method public static synthetic access$300(Lio/fabric/sdk/android/services/common/QueueFile;I[BII)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static synthetic access$400(Lio/fabric/sdk/android/services/common/QueueFile;)Ljava/io/RandomAccessFile;
    .locals 0
...
.method private static initialize(Ljava/io/File;)V
    ...
    .line 2
    invoke-static {v1}, Lio/fabric/sdk/android/services/common/QueueFile;->open(Ljava/io/File;)Ljava/io/RandomAccessFile;
    ...
    .line 5
    invoke-static {v3, v4}, Lio/fabric/sdk/android/services/common/QueueFile;->writeInts([B[I)V
...
.method public declared-synchronized add([BII)V
    ...
    .line 2
    invoke-static {p1, v1}, Lio/fabric/sdk/android/services/common/QueueFile;->nonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 7
    :goto_0
    new-instance v4, Lio/fabric/sdk/android/services/common/QueueFile$Element;

    invoke-direct {v4, v3, p3}, Lio/fabric/sdk/android/services/common/QueueFile$Element;-><init>(II)V
    ...
    invoke-static {v3, v5, p3}, Lio/fabric/sdk/android/services/common/QueueFile;->writeInt([BII)V

    .line 9
    iget v3, v4, Lio/fabric/sdk/android/services/common/QueueFile$Element;->position:I

    iget-object v6, p0, Lio/fabric/sdk/android/services/common/QueueFile;->buffer:[B

    invoke-direct {p0, v3, v6, v5, v2}, Lio/fabric/sdk/android/services/common/QueueFile;->ringWrite(I[BII)V
    ...
    invoke-direct {p0, v3, p1, p2, p3}, Lio/fabric/sdk/android/services/common/QueueFile;->ringWrite(I[BII)V

    if-eqz v1, :cond_1

    .line 11
    iget p1, v4, Lio/fabric/sdk/android/services/common/QueueFile$Element;->position:I
    ...
    iget v2, v4, Lio/fabric/sdk/android/services/common/QueueFile$Element;->position:I

    invoke-direct {p0, p2, p3, p1, v2}, Lio/fabric/sdk/android/services/common/QueueFile;->writeHeader(IIII)V

    .line 13
    iput-object v4, p0, Lio/fabric/sdk/android/services/common/QueueFile;->last:Lio/fabric/sdk/android/services/common/QueueFile$Element;
...
.method public declared-synchronized peek()[B
    ...
    invoke-direct {p0, v0, v2, v3, v1}, Lio/fabric/sdk/android/services/common/QueueFile;->ringRead(I[BII)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized remove()V
    ...
    invoke-direct {p0, v0, v2, v4, v3}, Lio/fabric/sdk/android/services/common/QueueFile;->ringRead(I[BII)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-direct {v2, p0, v1}, Lio/fabric/sdk/android/services/common/QueueFile$1;-><init>(Lio/fabric/sdk/android/services/common/QueueFile;Ljava/lang/StringBuilder;)V
    ...
    .line 9
    sget-object v3, Lio/fabric/sdk/android/services/common/QueueFile;->LOGGER:Ljava/util/logging/Logger;
