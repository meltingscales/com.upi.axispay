...
# direct methods
.method public constructor <init>(Lxg;Landroid/content/Context;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    sget v1, Lqg;->mr_controller_volume_item:I
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lxg$r;->c:Lxg;

    invoke-virtual {v1, p2}, Lxg;->P(Landroid/view/View;)V
    ...
    .line 8
    sget v2, Lng;->mr_volume_slider:I
    ...
    iget-object v3, p0, Lxg$r;->c:Lxg;

    iget-object v3, v3, Lxg;->E:Landroidx/mediarouter/app/OverlayListView;

    .line 11
    invoke-static {p3, v2, v3}, Ldh;->w(Landroid/content/Context;Landroidx/mediarouter/app/MediaRouteVolumeSlider;Landroid/view/View;)V

    .line 12
    invoke-virtual {v2, p1}, Landroid/widget/SeekBar;->setTag(Ljava/lang/Object;)V

    .line 13
    iget-object p3, p0, Lxg$r;->c:Lxg;

    iget-object p3, p3, Lxg;->R:Ljava/util/Map;
    ...
    invoke-virtual {p3, p1}, Lxg;->z(Lyh$i;)Z
    ...
    :cond_2
    :goto_1
    sget p3, Lng;->mr_volume_item_icon:I
    ...
    .line 26
    sget p3, Lng;->volume_item_container:I
    ...
    iget-object v1, v1, Lxg;->J:Ljava/util/Set;
    ...
    iget-object p3, p3, Lxg;->H:Ljava/util/Set;
