...
.method public constructor <init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
    ...
    .line 2
    iput-object p1, p0, Lad$a;->a:Landroid/view/ActionMode$Callback;

    .line 3
    iput-object p2, p0, Lad$a;->b:Landroid/widget/TextView;

    const/4 p1, 0x0

    .line 4
    iput-boolean p1, p0, Lad$a;->f:Z
...
.method public final b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    .line 1
    invoke-virtual {p0}, Lad$a;->a()Landroid/content/Intent;

    move-result-object v0

    .line 2
    invoke-virtual {p0, p2}, Lad$a;->d(Landroid/widget/TextView;)Z
...
.method public final c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 5
    invoke-virtual {p0, v1, p1}, Lad$a;->e(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method public final f(Landroid/view/Menu;)V
    ...
    .line 1
    iget-object v1, p0, Lad$a;->b:Landroid/widget/TextView;
    ...
    iput-object v3, p0, Lad$a;->c:Ljava/lang/Class;
    ...
    iput-object v3, p0, Lad$a;->d:Ljava/lang/reflect/Method;

    .line 8
    iput-boolean v6, p0, Lad$a;->e:Z
    :try_end_0
    ...
    .line 11
    iput-boolean v5, p0, Lad$a;->e:Z

    .line 12
    :cond_0
    :goto_0
    :try_start_1
    iget-boolean v3, p0, Lad$a;->e:Z

    if-eqz v3, :cond_1

    iget-object v3, p0, Lad$a;->c:Ljava/lang/Class;
    ...
    .line 13
    iget-object v3, p0, Lad$a;->d:Ljava/lang/reflect/Method;
    ...
    .line 21
    :cond_3
    invoke-virtual {p0, v1, v2}, Lad$a;->c(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    iget-object v8, p0, Lad$a;->b:Landroid/widget/TextView;

    .line 26
    invoke-virtual {p0, v4, v8}, Lad$a;->b(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    .line 1
    iget-object v0, p0, Lad$a;->a:Landroid/view/ActionMode$Callback;
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    .line 1
    invoke-virtual {p0, p2}, Lad$a;->f(Landroid/view/Menu;)V
