...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lvl0;)V
...
.method public constructor <init>(Lokio/BufferedSource;Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/Source;IIILvl0;)V
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Ltm0;->h(II)Lrm0;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Ltm0;->g(Lpm0;I)Lpm0;

    move-result-object p2

    invoke-virtual {p2}, Lpm0;->a()I

    move-result v1

    invoke-virtual {p2}, Lpm0;->b()I

    move-result v2

    invoke-virtual {p2}, Lpm0;->c()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-virtual {v11, v2}, Ljava/util/logging/Logger;->fine(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v8}, Lokhttp3/internal/http2/Http2;->formattedType$okhttp(I)Ljava/lang/String;
    ...
    invoke-interface {p1, v1, v2}, Lokio/BufferedSource;->skip(J)V

    goto :goto_1

    .line 9
    :pswitch_0
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readWindowUpdate(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 10
    :pswitch_1
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 11
    :pswitch_2
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 12
    :pswitch_3
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 13
    :pswitch_4
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 14
    :pswitch_5
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readRstStream(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 15
    :pswitch_6
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 16
    :pswitch_7
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readHeaders(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    .line 17
    :pswitch_8
    invoke-direct {p0, p2, v1, v9, v10}, Lokhttp3/internal/http2/Http2Reader;->readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
