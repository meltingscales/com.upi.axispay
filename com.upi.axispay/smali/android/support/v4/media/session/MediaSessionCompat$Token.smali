...
.field private mSession2Token:Lmo;
...
.method public constructor <init>(Ljava/lang/Object;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lmo;)V
...
.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lmo;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lmo;)V
    .locals 1
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lmo;
...
.method public static fromBundle(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 2
    invoke-static {p0, v1}, Li8;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 4
    invoke-static {p0, v2}, Lko;->b(Landroid/os/Bundle;Ljava/lang/String;)Lmo;
    ...
    invoke-direct {v0, p0, v1, v2}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lmo;)V
...
.method public getSession2Token()Lmo;
    .locals 2
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lmo;
...
.method public setSession2Token(Lmo;)V
    .locals 1
    ...
    .line 2
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lmo;
...
.method public toBundle()Landroid/os/Bundle;
    ...
    invoke-static {v0, v3, v2}, Li8;->b(Landroid/os/Bundle;Ljava/lang/String;Landroid/os/IBinder;)V

    .line 6
    :cond_0
    iget-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lmo;
    ...
    .line 7
    invoke-static {v0, v3, v2}, Lko;->c(Landroid/os/Bundle;Ljava/lang/String;Lmo;)V
