...
.method private d(Lorg/w3c/dom/Node;)[B
    ...
    iget-boolean v2, p0, Lorg/apache/xml/security/c14n/CanonicalizerSpi;->a:Z

    if-eqz v2, :cond_0

    iget-object v2, p0, Lorg/apache/xml/security/c14n/implementations/CanonicalizerBase;->n:Ljava/io/OutputStream;
    ...
    :cond_1
    instance-of v2, p1, Lorg/apache/xml/security/utils/UnsyncByteArrayOutputStream;
    ...
    check-cast v2, Lorg/apache/xml/security/utils/UnsyncByteArrayOutputStream;

    invoke-virtual {v2}, Lorg/apache/xml/security/utils/UnsyncByteArrayOutputStream;->b()V
    :try_end_0
    ...
    invoke-direct {v2, v1, p1}, Lorg/apache/xml/security/c14n/CanonicalizationException;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public a(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)[B
    ...
    invoke-virtual {p0, v2, p2}, Lorg/apache/xml/security/c14n/implementations/CanonicalizerBase;->d(Lorg/w3c/dom/Element;Lorg/apache/xml/security/c14n/implementations/NameSpaceSymbTable;)V

    const/4 v2, 0x0

    :cond_0
    invoke-virtual {p0, p1, p2, p1, v2}, Lorg/apache/xml/security/c14n/implementations/CanonicalizerBase;->a(Lorg/w3c/dom/Node;Lorg/apache/xml/security/c14n/implementations/NameSpaceSymbTable;Lorg/w3c/dom/Node;I)V
    ...
    invoke-direct {p2, v1, p1}, Lorg/apache/xml/security/c14n/CanonicalizationException;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public b(Lorg/apache/xml/security/signature/XMLSignatureInput;)[B
    ...
    iput-boolean v2, p0, Lorg/apache/xml/security/c14n/implementations/CanonicalizerBase;->k:Z
    ...
    invoke-virtual {p0, v2, p1}, Lorg/apache/xml/security/c14n/implementations/CanonicalizerBase;->a(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)[B
    ...
    iput-object v2, p0, Lorg/apache/xml/security/c14n/implementations/CanonicalizerBase;->j:Ljava/util/List;
