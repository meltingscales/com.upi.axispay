...
public class AlertDialogLayout extends z2 {
    ...
    private void l(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                z2.a aVar = (z2.a) childAt.getLayoutParams();
    ...
    public final boolean C(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == q.topPanel) {
                    view = childAt;
                } else if (id == q.buttonPanel) {
                    view2 = childAt;
                } else if ((id != q.contentPanel && id != q.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(i4, CommonUtils.BYTES_IN_A_GIGABYTE));
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            z2$a r15 = (defpackage.z2.a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = defpackage.ac.C(r17)
            int r2 = defpackage.ib.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L97
            r3 = 5
