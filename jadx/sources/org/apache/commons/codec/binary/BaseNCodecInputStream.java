...
public class BaseNCodecInputStream extends FilterInputStream {
    ...
    public synchronized void reset() throws IOException {
        throw new IOException(C0059ao.a(11520));
    }
    ...
    public long skip(long j) throws IOException {
        int read;
        if (j < 0) {
            throw new IllegalArgumentException(C0059ao.a(11521) + j);
        }
        byte[] bArr = new byte[Barcode.UPC_A];
        long j2 = j;
        while (j2 > 0 && (read = read(bArr, 0, (int) Math.min((long) Barcode.UPC_A, j2))) != -1) {
            j2 -= read;
        }
        return j - j2;
    }
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        Objects.requireNonNull(bArr, C0059ao.a(11519));
        if (i >= 0 && i2 >= 0) {
            ...
            while (i3 == 0) {
                if (!this.baseNCodec.hasData(this.context)) {
                    byte[] bArr2 = new byte[this.doEncode ? Barcode.AZTEC : UserMetadata.MAX_INTERNAL_KEY_SIZE];
