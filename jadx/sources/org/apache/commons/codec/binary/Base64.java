...
public class Base64 extends BaseNCodec {
    ...
    private static final int MASK_2BITS = 0;
    private static final int MASK_4BITS = 0;
    private static final int MASK_6BITS = 0;
    ...
    public static byte[] encodeInteger(BigInteger bigInteger) {
        Objects.requireNonNull(bigInteger, C0059ao.a(15223));
    ...
    private void validateCharacter(int i, BaseNCodec.Context context) {
        if (isStrictDecoding() && (i & context.ibitWorkArea) != 0) {
            throw new IllegalArgumentException(C0059ao.a(15224));
        }
    }

    private void validateTrailingCharacter() {
        if (isStrictDecoding()) {
            throw new IllegalArgumentException(C0059ao.a(15225));
        }
    }
    ...
    public void decode(byte[] bArr, int i, int i2, BaseNCodec.Context context) {
        ...
        if (i10 == 1) {
            ...
            throw new IllegalStateException(C0059ao.a(15226) + context.modulus);
        }
    }
    ...
    public void encode(byte[] bArr, int i, int i2, BaseNCodec.Context context) {
        ...
        if (i16 != 0) {
            if (i16 == 1) {
                ...
                throw new IllegalStateException(C0059ao.a(15227) + context.modulus);
            }
        }
    ...
    public static byte[] encodeBase64(byte[] bArr, boolean z, boolean z2, int i) {
        ...
        throw new IllegalArgumentException(C0059ao.a(15221) + encodedLength + C0059ao.a(15222) + i);
    }
    ...
    public Base64(int i, byte[] bArr, boolean z, CodecPolicy codecPolicy) {
        ...
        if (bArr != null) {
            if (containsAlphabetOrPad(bArr)) {
                ...
                throw new IllegalArgumentException(C0059ao.a(15219) + newStringUtf8 + C0059ao.a(15220));
            } else if (i > 0) {
