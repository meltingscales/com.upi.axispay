...
public class QuotedPrintableCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
    private static final byte CR = 0;
    private static final byte ESCAPE_CHAR = 0;
    private static final byte LF = 0;
    private static final BitSet PRINTABLE_CHARS;
    private static final int SAFE_LENGTH = 0;
    private static final byte SPACE = 0;
    private static final byte TAB = 0;
    private final Charset charset;
    private final boolean strict;

    static {
        C0059ao.a(QuotedPrintableCodec.class, 121);
        PRINTABLE_CHARS = new BitSet(Barcode.QR_CODE);
        for (int i = 33; i <= 60; i++) {
        ...
        while (i < bArr.length) {
            ...
            if (b == 61) {
                ...
                try {
                    ...
                    throw new DecoderException(C0059ao.a(4373), e);
                }
            } else if (b != 13 && b != 10) {
    ...
    public Object encode(Object obj) throws EncoderException {
        ...
        throw new EncoderException(C0059ao.a(4376) + obj.getClass().getName() + C0059ao.a(4377));
    }
    ...
    public Object decode(Object obj) throws DecoderException {
        ...
        throw new DecoderException(C0059ao.a(4374) + obj.getClass().getName() + C0059ao.a(4375));
    }
