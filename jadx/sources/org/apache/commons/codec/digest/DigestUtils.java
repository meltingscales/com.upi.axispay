...
public class DigestUtils {
    private static final int STREAM_BUFFER_LENGTH = 0;
    private final MessageDigest messageDigest;

    static {
        C0059ao.a(DigestUtils.class, 344);
    }
    ...
    public static MessageDigest getMd2Digest() {
        return getDigest(C0059ao.a(1578));
    }

    public static MessageDigest getMd5Digest() {
        return getDigest(C0059ao.a(1579));
    }

    public static MessageDigest getSha1Digest() {
        return getDigest(C0059ao.a(1580));
    }

    public static MessageDigest getSha256Digest() {
        return getDigest(C0059ao.a(1581));
    }

    public static MessageDigest getSha384Digest() {
        return getDigest(C0059ao.a(1582));
    }

    public static MessageDigest getSha3_224Digest() {
        return getDigest(C0059ao.a(1583));
    }

    public static MessageDigest getSha3_256Digest() {
        return getDigest(C0059ao.a(1584));
    }

    public static MessageDigest getSha3_384Digest() {
        return getDigest(C0059ao.a(1585));
    }

    public static MessageDigest getSha3_512Digest() {
        return getDigest(C0059ao.a(1586));
    }

    public static MessageDigest getSha512Digest() {
        return getDigest(C0059ao.a(1587));
    }

    public static MessageDigest getSha512_224Digest() {
        return getDigest(C0059ao.a(1588));
    }

    public static MessageDigest getSha512_256Digest() {
        return getDigest(C0059ao.a(1589));
    }
