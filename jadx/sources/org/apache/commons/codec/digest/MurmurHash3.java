...
public final class MurmurHash3 {
    ...
    private static final int C1_32 = 0;
    private static final long C2 = 0;
    private static final int C2_32 = 0;
    public static final int DEFAULT_SEED = 0;
    public static final int INTEGER_BYTES = 0;
    public static final int LONG_BYTES = 0;
    private static final int M = 0;
    private static final int M_32 = 0;
    private static final int N1 = 0;
    private static final int N2 = 0;
    @Deprecated
    public static final long NULL_HASHCODE = 0;
    private static final int N_32 = 0;
    private static final int R1 = 0;
    private static final int R1_32 = 0;
    private static final int R2 = 0;
    private static final int R2_32 = 0;
    private static final int R3 = 0;
    public static final int SHORT_BYTES = 0;
    ...
    public static class IncrementalHash32x86 {
        ...
        static {
            C0059ao.a(IncrementalHash32x86.class, 297);
        }
        ...
        public final void add(byte[] bArr, int i, int i2) {
            ...
            if (i3 > 0) {
                if (i3 == 1) {
                    ...
                    throw new IllegalStateException(C0059ao.a(11377) + this.unprocessedLength);
                }
    ...
    static {
        C0059ao.a(MurmurHash3.class, 74);
    }
    ...
    private static long[] hash128x64Internal(byte[] bArr, int i, int i2, long j) {
        ...
        while (i5 < i4) {
            ...
            long rotateLeft = ((Long.rotateLeft((Long.rotateLeft(littleEndianLong * (-8663945395140668459L), 31) * 5545529020109919103L) ^ j9, 27) + j10) * 5) + 1390208809;
            j10 = ((Long.rotateLeft(j10 ^ (Long.rotateLeft(5545529020109919103L * littleEndianLong2, 33) * (-8663945395140668459L)), 31) + rotateLeft) * 5) + 944331445;
            i5++;
            j9 = rotateLeft;
            bArr2 = bArr;
        }
    ...
    public static long hash64(int i) {
        return fmix64(((Long.rotateLeft((Integer.reverseBytes(i) & 4294967295L) * (-8663945395140668459L), 31) * 5545529020109919103L) ^ 104729) ^ 4);
    }

    @Deprecated
    public static long hash64(short s) {
        return fmix64(((Long.rotateLeft(((((s & 255) << 8) ^ 0) ^ (255 & ((s & 65280) >> 8))) * (-8663945395140668459L), 31) * 5545529020109919103L) ^ 104729) ^ 2);
    }
    ...
    public static long hash64(byte[] bArr, int i, int i2, int i3) {
        ...
        int i5 = i2 >> 3;
        for (int i6 = 0; i6 < i5; i6++) {
            j = (Long.rotateLeft(j ^ (Long.rotateLeft(getLittleEndianLong(bArr, i + (i6 << 3)) * (-8663945395140668459L), 31) * 5545529020109919103L), 27) * 5) + 1390208809;
        }
        long j2 = 0;
        switch ((i + i2) - (i + (i5 << 3))) {
            case 1:
