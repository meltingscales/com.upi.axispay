...
public class Sha2Crypt {
    private static final int ROUNDS_DEFAULT = 0;
    private static final int ROUNDS_MAX = 0;
    private static final int ROUNDS_MIN = 0;
    private static final String ROUNDS_PREFIX = null;
    private static final Pattern SALT_PATTERN;
    private static final int SHA256_BLOCKSIZE = 0;
    public static final String SHA256_PREFIX = null;
    private static final int SHA512_BLOCKSIZE = 0;
    public static final String SHA512_PREFIX = null;

    static {
        C0059ao.a(Sha2Crypt.class, 166);
        SALT_PATTERN = Pattern.compile(C0059ao.a(13999));
    }
    ...
    private static String sha2Crypt(byte[] bArr, String str, String str2, int i, String str3) {
        ...
        if (str != null) {
            ...
            if (matcher.find()) {
                ...
                String a = C0059ao.a(14004);
                if (z) {
                    sb.append(C0059ao.a(14005));
                    sb.append(i2);
                    sb.append(a);
                }
                sb.append(group);
            ...
            throw new IllegalArgumentException(C0059ao.a(14006) + str);
        }
        throw new IllegalArgumentException(C0059ao.a(14007));
    }
    ...
    public static String sha256Crypt(byte[] bArr, String str) {
        String a = C0059ao.a(14000);
        if (str == null) {
            str = a + B64.getRandomSalt(8);
        }
        return sha2Crypt(bArr, str, a, 32, C0059ao.a(14001));
    }

    public static String sha512Crypt(byte[] bArr, String str) {
        String a = C0059ao.a(14008);
        if (str == null) {
            str = a + B64.getRandomSalt(8);
        }
        return sha2Crypt(bArr, str, a, 64, C0059ao.a(14009));
    }

    public static String sha256Crypt(byte[] bArr, String str, Random random) {
        String a = C0059ao.a(14002);
        if (str == null) {
            str = a + B64.getRandomSalt(8, random);
        }
        return sha2Crypt(bArr, str, a, 32, C0059ao.a(14003));
    }

    public static String sha512Crypt(byte[] bArr, String str, Random random) {
        String a = C0059ao.a(14010);
        if (str == null) {
            str = a + B64.getRandomSalt(8, random);
        }
        return sha2Crypt(bArr, str, a, 64, C0059ao.a(14011));
    }
}
