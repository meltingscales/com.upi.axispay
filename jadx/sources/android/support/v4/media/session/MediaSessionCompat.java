...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((bg) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new bg(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        i8.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
                        ko.c(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            bg currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(bg bgVar);
        ...
        void setPlaybackToRemote(gg ggVar);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, mo moVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, moVar, bundle);
        }
        ...
        public int getRccTransportControlFlagsFromActions(long j) {
            ...
            return (j & 256) != 0 ? rccTransportControlFlagsFromActions | Barcode.QR_CODE : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, mo moVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, moVar, bundle);
        }
        ...
        public int getRccTransportControlFlagsFromActions(long j) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j);
            return (j & 128) != 0 ? rccTransportControlFlagsFromActions | Barcode.UPC_A : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, mo moVar, Bundle bundle) {
            super(context, str, moVar, bundle);
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, mo moVar, Bundle bundle) {
            super(context, str, moVar, bundle);
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final bg getCurrentControllerInfo() {
            return new bg(this.mSessionFwk.getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(bg bgVar) {
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, mo moVar, Bundle bundle) {
            super(context, str, moVar, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public int mFlags = 3;
        private gg.a mVolumeCallback = new gg.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // defpackage.gg.a
            public void onVolumeChanged(gg ggVar) {
                if (MediaSessionImplBase.this.mVolumeProvider != ggVar) {
                    return;
                }
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    gg ggVar = mediaSessionImplBase.mVolumeProvider;
                    if (i != 2) {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new bg(MediaSessionImplBase.this.getPackageNameForUid(Binder.getCallingUid()), Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new bg(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, mo moVar, Bundle bundle) {
            if (componentName != null) {
                ...
                this.mToken = new Token(mediaSessionStub, null, moVar);
                this.mRatingType = 0;
                this.mVolumeType = 1;
                this.mLocalStream = 3;
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public bg getCurrentControllerInfo() {
            bg bgVar;
            synchronized (this.mLock) {
                bgVar = this.mRemoteUserInfo;
            }
            return bgVar;
        }
        ...
        */
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(gg ggVar) {
            if (ggVar != null) {
                gg ggVar2 = this.mVolumeProvider;
                if (ggVar2 != null) {
                    ggVar2.e(null);
                }
                this.mVolumeType = 2;
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(i8.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            mo b = ko.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
        ...
        public mo getSession2Token() {
            mo moVar;
            synchronized (this.mLock) {
                moVar = this.mSession2Token;
            }
            return moVar;
        }
        ...
        public void setSession2Token(mo moVar) {
            synchronized (this.mLock) {
                this.mSession2Token = moVar;
            }
        }
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                ...
                if (iMediaSession != null) {
                    i8.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                }
                mo moVar = this.mSession2Token;
                if (moVar != null) {
                    ko.c(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, moVar);
                }
            }
            return bundle;
        }
        ...
        public Token(Object obj, IMediaSession iMediaSession, mo moVar) {
    ...
    static {
        PENDING_INTENT_FLAG_MUTABLE = z9.d() ? 33554432 : 0;
    }
    ...
    public void setPlaybackToRemote(gg ggVar) {
        if (ggVar != null) {
            this.mImpl.setPlaybackToRemote(ggVar);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, mo moVar) {
        this.mActiveListeners = new ArrayList<>();
        if (context != null) {
            if (!TextUtils.isEmpty(str)) {
                if (componentName == null && (componentName = hg.a(context)) == null) {
                ...
                if (i >= 21) {
                    if (i >= 29) {
                        this.mImpl = new MediaSessionImplApi29(context, str, moVar, bundle);
                    } else if (i >= 28) {
                        this.mImpl = new MediaSessionImplApi28(context, str, moVar, bundle);
                    } else if (i >= 22) {
                        this.mImpl = new MediaSessionImplApi22(context, str, moVar, bundle);
                    } else {
                        this.mImpl = new MediaSessionImplApi21(context, str, moVar, bundle);
                    }
                    ...
                    this.mImpl = new MediaSessionImplApi19(context, str, componentName2, pendingIntent2, moVar, bundle);
                } else if (i >= 18) {
                    this.mImpl = new MediaSessionImplApi18(context, str, componentName2, pendingIntent2, moVar, bundle);
                } else {
                    this.mImpl = new MediaSessionImplBase(context, str, componentName2, pendingIntent2, moVar, bundle);
                }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new bg("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public MediaSessionImplApi21(Context context, String str, mo moVar, Bundle bundle) {
            MediaSession createFwkMediaSession = createFwkMediaSession(context, str, bundle);
            this.mSessionFwk = createFwkMediaSession;
            this.mToken = new Token(createFwkMediaSession.getSessionToken(), new ExtraSession(), moVar);
            this.mSessionInfo = bundle;
            setFlags(3);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(gg ggVar) {
            this.mSessionFwk.setPlaybackToRemote((VolumeProvider) ggVar.b());
        }
