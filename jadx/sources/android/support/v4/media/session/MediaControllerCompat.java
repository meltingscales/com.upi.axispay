...
public final class MediaControllerCompat {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(i8.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(ko.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(fg.media_controller_compat_view_tag);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(fg.media_controller_compat_view_tag, mediaControllerCompat);
        if (Build.VERSION.SDK_INT >= 21) {
