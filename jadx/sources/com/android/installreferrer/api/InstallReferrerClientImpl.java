...
public class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public final class InstallReferrerServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            InstallReferrerClientImpl.this.service = gv.a.j(iBinder);
    ...
    private boolean isPlayStoreCompatible() {
        return this.mApplicationContext.getPackageManager().getPackageInfo("com.android.vending", Barcode.ITF).versionCode >= PLAY_STORE_MIN_APP_VER;
    }
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        if (isReady()) {
            ...
            try {
                return new ReferrerDetails(this.service.f(bundle));
