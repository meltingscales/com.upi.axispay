...
public final class AnimatorSet extends Animator {
    ...
    public static class Dependency {
        ...
        static {
            C0059ao.a(Dependency.class, 144);
        }
    ...
    private void sortNodes() {
        if (this.mNeedsSort) {
            ...
            if (this.mSortedNodes.size() != this.mNodes.size()) {
                throw new IllegalStateException(C0059ao.a(9962));
            }
            return;
        }
    ...
    public AnimatorSet setDuration(long j) {
        ...
        throw new IllegalArgumentException(C0059ao.a(9963));
    }
    ...
    public AnimatorSet mo236clone() {
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m237clone = next.m237clone();
            hashMap.put(next, m237clone);
            animatorSet.mNodes.add(m237clone);
            animatorSet.mNodeMap.put(m237clone.animation, m237clone);
            ArrayList arrayList = null;
            m237clone.dependencies = null;
            m237clone.tmpDependencies = null;
            m237clone.nodeDependents = null;
            m237clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m237clone.animation.getListeners();
            if (listeners != null) {
