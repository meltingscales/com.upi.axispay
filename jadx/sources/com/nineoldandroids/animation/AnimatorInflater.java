...
public class AnimatorInflater {
    ...
    private static final int Animator_repeatCount = 0;
    private static final int Animator_repeatMode = 0;
    private static final int Animator_startOffset = 0;
    private static final int Animator_valueFrom = 0;
    private static final int Animator_valueTo = 0;
    private static final int Animator_valueType = 0;
    ...
    static {
        C0059ao.a(AnimatorInflater.class, 154);
            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    ...
                    if (name.equals(C0059ao.a(652))) {
                        ...
                        throw new RuntimeException(C0059ao.a(655) + xmlPullParser.getName());
                    }
                    if (animatorSet != null) {
                        if (arrayList == null) {
