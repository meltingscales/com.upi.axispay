...
public final class CodedOutputStream implements Flushable {
    ...
    public static final int LITTLE_ENDIAN_32_SIZE = 0;
    public static final int LITTLE_ENDIAN_64_SIZE = 0;
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        static {
            C0059ao.a(OutOfSpaceException.class, 89);
        }

        public OutOfSpaceException() {
            super(C0059ao.a(8967));
        }
    }

    static {
        C0059ao.a(CodedOutputStream.class, 216);
    }
    ...
    public static int computeStringSizeNoTag(String str) {
        try {
            byte[] bytes = str.getBytes(C0059ao.a(220));
            return computeRawVarint32Size(bytes.length) + bytes.length;
        } catch (UnsupportedEncodingException e) {
            throw new RuntimeException(C0059ao.a(221), e);
        }
    }
    ...
    public static CodedOutputStream newInstance(OutputStream outputStream) {
        return newInstance(outputStream, Barcode.AZTEC);
    }
    ...
    public void checkNoSpaceLeft() {
        if (spaceLeft() != 0) {
            throw new IllegalStateException(C0059ao.a(222));
        }
    }
    ...
    public int spaceLeft() {
        ...
        throw new UnsupportedOperationException(C0059ao.a(223));
    }
    ...
    public void writeRawVarint32(int i) throws IOException {
        while ((i & (-128)) != 0) {
            writeRawByte((i & 127) | Barcode.ITF);
            i >>>= 7;
        }
        writeRawByte(i);
    }
    ...
    public void writeRawVarint64(long j) throws IOException {
        while (((-128) & j) != 0) {
            writeRawByte((((int) j) & 127) | Barcode.ITF);
            j >>>= 7;
        }
        writeRawByte((int) j);
    }
    ...
    public void writeStringNoTag(String str) throws IOException {
        byte[] bytes = str.getBytes(C0059ao.a(226));
    ...
    public void writeRawBytes(ByteString byteString, int i, int i2) throws IOException {
        ...
        if (j != newInput.skip(j)) {
            throw new IllegalStateException(C0059ao.a(225));
        }
        while (i7 > 0) {
            ...
            if (read == min) {
                ...
                throw new IllegalStateException(C0059ao.a(224));
            }
        }
    }
}
