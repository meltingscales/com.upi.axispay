...
public class CLSUUID {
    ...
    public CLSUUID(IdManager idManager) {
        ...
        _clsId = String.format(locale, C0059ao.a(5752), hexify.substring(0, 12), hexify.substring(12, 16), hexify.subSequence(16, 20), sha1.substring(0, 12)).toUpperCase(locale);
    }
