...
public final class WireFormat {
    public static final int MESSAGE_SET_ITEM = 0;
    public static final int MESSAGE_SET_ITEM_END_TAG;
    public static final int MESSAGE_SET_ITEM_TAG;
    public static final int MESSAGE_SET_MESSAGE = 0;
    public static final int MESSAGE_SET_MESSAGE_TAG;
    public static final int MESSAGE_SET_TYPE_ID = 0;
    public static final int MESSAGE_SET_TYPE_ID_TAG;
    public static final int TAG_TYPE_BITS = 0;
    public static final int TAG_TYPE_MASK = 0;
    public static final int WIRETYPE_END_GROUP = 0;
    public static final int WIRETYPE_FIXED32 = 0;
    public static final int WIRETYPE_FIXED64 = 0;
    public static final int WIRETYPE_LENGTH_DELIMITED = 0;
    public static final int WIRETYPE_START_GROUP = 0;
    ...
    public static class FieldType {
        ...
        static {
            ...
            BOOL = fieldType8;
            FieldType fieldType9 = new FieldType("STRING", 8, JavaType.STRING, 2) { // from class: com.crashlytics.android.core.WireFormat.FieldType.1
            ...
            FieldType fieldType10 = new FieldType("GROUP", 9, javaType3, 3) { // from class: com.crashlytics.android.core.WireFormat.FieldType.2
                @Override // com.crashlytics.android.core.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            GROUP = fieldType10;
            FieldType fieldType11 = new FieldType("MESSAGE", 10, javaType3, 2) { // from class: com.crashlytics.android.core.WireFormat.FieldType.3
                @Override // com.crashlytics.android.core.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
            ...
            MESSAGE = fieldType11;
            FieldType fieldType12 = new FieldType("BYTES", 11, JavaType.BYTE_STRING, 2) { // from class: com.crashlytics.android.core.WireFormat.FieldType.4
                @Override // com.crashlytics.android.core.WireFormat.FieldType
                public boolean isPackable() {
                    return false;
                }
    ...
    static {
        C0059ao.a(WireFormat.class, 293);
