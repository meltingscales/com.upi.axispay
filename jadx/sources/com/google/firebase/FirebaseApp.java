...
public class FirebaseApp {
    ...
    @GuardedBy("LOCK")
    public static final Map<String, FirebaseApp> INSTANCES = new o4();
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: l00
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: k00
