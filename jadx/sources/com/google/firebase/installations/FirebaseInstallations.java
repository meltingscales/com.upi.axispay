...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    */
    ...
    public final void f(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: p20
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: s20
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: q20
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: r20
            @Override // java.lang.Runnable
            public final void run() {
