                    ...
                    if (charAt2 < 2048) {
                        ...
                        if (i5 != charSequence.length()) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                byteBuffer.put((byte) (((codePoint >>> 12) & 63) | Barcode.ITF));
                                byteBuffer.put((byte) (((codePoint >>> 6) & 63) | Barcode.ITF));
                                byteBuffer.put((byte) ((codePoint & 63) | Barcode.ITF));
                                i4 = i5;
                                i4++;
                            } else {
                                i4 = i5;
                        ...
                        i3 = ((charAt2 >>> 6) & 63) | Barcode.ITF;
                    }
                    byteBuffer.put((byte) i3);
                    c = (charAt2 & '?') | Barcode.ITF;
                }
                ...
                while (i4 < length2) {
                    ...
                    if (charAt4 >= 128 || i >= i6) {
                        if (charAt4 < 2048 && i <= i6 - 2) {
                            ...
                            i = i8 + 1;
                            array[i8] = (byte) ((charAt4 & '?') | Barcode.ITF);
                            ...
                            if (i9 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(charAt4, charAt5)) {
                                    ...
                                    int i11 = i10 + 1;
                                    array[i10] = (byte) (((codePoint2 >>> 12) & 63) | Barcode.ITF);
                                    int i12 = i11 + 1;
                                    array[i11] = (byte) (((codePoint2 >>> 6) & 63) | Barcode.ITF);
                                    i = i12 + 1;
                                    array[i12] = (byte) ((codePoint2 & 63) | Barcode.ITF);
                                    i4 = i9;
                                } else {
                                    i4 = i9;
                                }
                            ...
                            int i14 = i13 + 1;
                            array[i13] = (byte) (((charAt4 >>> 6) & 63) | Barcode.ITF);
                            i2 = i14 + 1;
                            array[i14] = (byte) ((charAt4 & '?') | Barcode.ITF);
                        }
                        i4++;
                    } else {
                        i2 = i + 1;
