...
public abstract class zzbn extends zzba {
        ...
        public final void zzb(long j) throws IOException {
            if (zzbn.zzfy && zzag() >= 10) {
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    zzfd.zza(bArr, i, (byte) ((((int) j) & 127) | Barcode.ITF));
                    j >>>= 7;
                }
        ...
        public final void zzo(int i) throws IOException {
            if (zzbn.zzfy && zzag() >= 10) {
                while ((i & (-128)) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    zzfd.zza(bArr, i2, (byte) ((i & 127) | Barcode.ITF));
                    i >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i3 = this.position;
    ...
    public static final class zzd extends zzbn {
        ...
        public final void zzb(long j) throws IOException {
            while (((-128) & j) != 0) {
                try {
                    this.zzgd.put((byte) ((((int) j) & 127) | Barcode.ITF));
                    j >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new zzc(e);
                }
        ...
        public final void zzo(int i) throws IOException {
            while ((i & (-128)) != 0) {
                try {
                    this.zzgd.put((byte) ((i & 127) | Barcode.ITF));
                    i >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new zzc(e);
                }
        ...
        public final void zzb(long j) throws IOException {
            if (this.zzgi <= this.zzgh) {
                while ((j & (-128)) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((((int) j) & 127) | Barcode.ITF));
                    j >>>= 7;
                }
                long j3 = this.zzgi;
                this.zzgi = 1 + j3;
            ...
            while (true) {
                ...
                this.zzgi = j4 + 1;
                zzfd.zza(j4, (byte) ((((int) j) & 127) | Barcode.ITF));
                j >>>= 7;
            }
        }
        ...
        public final void zzo(int i) throws IOException {
            ...
            if (this.zzgi <= this.zzgh) {
                while (true) {
                    ...
                    this.zzgi = j + 1;
                    zzfd.zza(j, (byte) ((i & 127) | Barcode.ITF));
                    i >>>= 7;
                }
            } else {
                while (true) {
