...
public final class zzth extends zztj {
    ...
    public /* synthetic */ zzth(InputStream inputStream, int i, zztg zztgVar) {
        ...
        this.zzf = new byte[Barcode.AZTEC];
        this.zzg = 0;
        this.zzi = 0;
        this.zzk = 0;
    }
    ...
    private final List<byte[]> zzu(int i) throws IOException {
        ...
        while (i > 0) {
            int min = Math.min(i, (int) Barcode.AZTEC);
    ...
    private final boolean zzx(int i) throws IOException {
        ...
        if (i2 + i > i3) {
            ...
            if (i <= (Api.BaseClientBuilder.API_PRIORITY_OTHER - i4) - i2 && i4 + i2 + i <= this.zzl) {
                ...
                try {
                    int read = this.zze.read(this.zzf, i3, Math.min(4096 - i3, (Api.BaseClientBuilder.API_PRIORITY_OTHER - i4) - i3));
