...
public final class zzeu {
    ...
    static {
        ...
        Integer valueOf2 = Integer.valueOf((int) RecyclerView.MAX_SCROLL_DURATION);
        zzf = zzet.zza(valueOf2, 20000, new zzes() { // from class: com.google.android.gms.internal.gtm.zzeg
        });
        zzg = zzet.zza(valueOf2, valueOf2, new zzes() { // from class: com.google.android.gms.internal.gtm.zzei
        });
        ...
        Integer valueOf3 = Integer.valueOf((int) UserMetadata.MAX_INTERNAL_KEY_SIZE);
        zzy = zzet.zza(valueOf3, valueOf3, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdi
        });
        zzz = zzet.zza(valueOf3, valueOf3, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdj
        });
        zzA = zzet.zza(valueOf3, valueOf3, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdk
        });
        zzB = zzet.zza("404,502", "404,502", new zzes() { // from class: com.google.android.gms.internal.gtm.zzdm
        });
        Integer valueOf4 = Integer.valueOf((int) SettingsJsonConstants.SETTINGS_CACHE_DURATION_DEFAULT);
        zzC = zzet.zza(valueOf4, valueOf4, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdn
        });
