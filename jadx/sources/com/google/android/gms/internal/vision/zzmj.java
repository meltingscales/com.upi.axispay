    ...
    public final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i4 < length) {
            ...
            if (charAt3 < c && j4 < j5) {
                ...
                long j8 = j7 + j;
                zzma.zza(bArr, j7, (byte) ((charAt3 & '?') | Barcode.ITF));
                long j9 = j;
                c2 = 128;
                j2 = j8;
                j3 = j9;
                ...
                if (j4 <= j5 - 4) {
                    ...
                    if (i5 != length) {
                        ...
                        if (Character.isSurrogatePair(charAt3, charAt4)) {
                            ...
                            long j11 = j10 + 1;
                            c2 = 128;
                            zzma.zza(bArr, j10, (byte) (((codePoint >>> 12) & 63) | Barcode.ITF));
                            long j12 = j11 + 1;
                            zzma.zza(bArr, j11, (byte) (((codePoint >>> 6) & 63) | Barcode.ITF));
                            j3 = 1;
                            j2 = j12 + 1;
                            zzma.zza(bArr, j12, (byte) ((codePoint & 63) | Barcode.ITF));
                            i4 = i5;
                        } else {
                            i4 = i5;
                        }
                ...
                long j14 = j13 + j;
                zzma.zza(bArr, j13, (byte) (((charAt3 >>> 6) & 63) | Barcode.ITF));
                zzma.zza(bArr, j14, (byte) ((charAt3 & '?') | Barcode.ITF));
                j2 = j14 + 1;
                j3 = 1;
                c2 = 128;
            }
