...
public class zzfh extends IOException {
    ...
    public static zzfh zznb() {
        return new zzfh("Failed to parse the message.");
    }

    public static zzfh zznc() {
