    ...
    public final void zad(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        try {
            if (activity instanceof sd) {
                SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((sd) activity).D(), str);
                return;
            }
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                eVar.q(context.getApplicationInfo().icon);
                eVar.p(2);
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    eVar.a(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
                } else {
                    eVar.i(pendingIntent);
                }
            } else {
                eVar.q(17301642);
                eVar.t(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker));
