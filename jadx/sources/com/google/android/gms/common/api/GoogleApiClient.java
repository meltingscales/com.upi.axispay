...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(sd sdVar);
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                o4Var.put(api2, Boolean.valueOf(z2));
                ...
                o4Var2.put(api2.zab(), buildClient);
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, o4Var, this.zaq, this.zar, o4Var2, this.zal, zabe.zad(o4Var2.values(), true), arrayList);
        ...
        public Builder enableAutoManage(sd sdVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) sdVar);
        ...
        public Builder enableAutoManage(sd sdVar, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(sdVar, 0, onConnectionFailedListener);
            return this;
        }
