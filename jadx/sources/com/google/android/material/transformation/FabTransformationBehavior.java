...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        public c(FabTransformationBehavior fabTransformationBehavior, uw uwVar, Drawable drawable) {
            this.a = uwVar;
            this.b = drawable;
        }
    ...
    public class d extends AnimatorListenerAdapter {
        ...
        public d(FabTransformationBehavior fabTransformationBehavior, uw uwVar) {
            this.a = uwVar;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            uw.e revealInfo = this.a.getRevealInfo();
    ...
    public final ViewGroup K(View view) {
        View findViewById = view.findViewById(mv.mtrl_child_content_container);
        if (findViewById != null) {
            return f0(findViewById);
        }
        if (!(view instanceof i00) && !(view instanceof h00)) {
            return f0(view);
        }
        return f0(((ViewGroup) view).getChildAt(0));
    }

    public final void L(View view, e eVar, bw bwVar, bw bwVar2, float f, float f2, float f3, float f4, RectF rectF) {
        float S = S(eVar, bwVar, f, f3);
        float S2 = S(eVar, bwVar2, f2, f4);
        Rect rect = this.c;
    ...
    public final Pair<bw, bw> N(float f, float f2, boolean z, e eVar) {
        bw e2;
        bw e3;
        int i;
        if (f == 0.0f || f2 == 0.0f) {
    ...
    public final float O(View view, View view2, cw cwVar) {
        RectF rectF = this.d;
        RectF rectF2 = this.e;
        M(view, rectF);
        T(view2, rectF2);
        rectF2.offset(-Q(view, view2, cwVar), 0.0f);
        return rectF.centerX() - rectF2.left;
    }

    public final float P(View view, View view2, cw cwVar) {
        RectF rectF = this.d;
        RectF rectF2 = this.e;
        M(view, rectF);
        T(view2, rectF2);
        rectF2.offset(0.0f, -R(view, view2, cwVar));
        return rectF.centerY() - rectF2.top;
    }

    public final float Q(View view, View view2, cw cwVar) {
        float centerX;
        float centerX2;
        float f;
        RectF rectF = this.d;
    ...
    public final float R(View view, View view2, cw cwVar) {
        float centerY;
        float centerY2;
        float f;
        RectF rectF = this.d;
    ...
    public final float S(e eVar, bw bwVar, float f, float f2) {
        long c2 = bwVar.c();
        long d2 = bwVar.d();
        bw e2 = eVar.a.e("expansion");
        return tv.a(f, f2, bwVar.e().getInterpolation(((float) (((e2.c() + e2.d()) + 17) - c2)) / ((float) d2)));
    }
    ...
    public final void U(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof ViewGroup) {
            if (((view2 instanceof uw) && tw.a == 0) || (K = K(view2)) == null) {
                return;
            }
            if (z) {
                if (!z2) {
                    wv.a.set(K, Float.valueOf(0.0f));
                }
                ofFloat = ObjectAnimator.ofFloat(K, wv.a, 1.0f);
            } else {
                ofFloat = ObjectAnimator.ofFloat(K, wv.a, 0.0f);
            }
    ...
    public final void V(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof uw) {
            uw uwVar = (uw) view2;
            int d0 = d0(view);
            int i = 16777215 & d0;
            if (z) {
                if (!z2) {
                    uwVar.setCircularRevealScrimColor(d0);
                }
                ofInt = ObjectAnimator.ofInt(uwVar, uw.d.a, i);
            } else {
                ofInt = ObjectAnimator.ofInt(uwVar, uw.d.a, d0);
            }
            ofInt.setEvaluator(vv.b());
    ...
    public final void W(View view, View view2, boolean z, e eVar, List<Animator> list) {
        ...
        Pair<bw, bw> N = N(Q, R, z, eVar);
        bw bwVar = (bw) N.first;
        bw bwVar2 = (bw) N.second;
    ...
    public final void X(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (z) {
            ...
            ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, -w);
        }
    ...
    public final void Y(View view, View view2, boolean z, boolean z2, e eVar, float f, float f2, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof uw) {
            ...
            if (z) {
                if (!z2) {
                    uwVar.setRevealInfo(new uw.e(O, P, width));
                }
                if (z2) {
                    width = uwVar.getRevealInfo().c;
                }
                animator = rw.a(uwVar, O, P, py.b(O, P, 0.0f, 0.0f, f, f2));
                animator.addListener(new d(this, uwVar));
                b0(view2, e2.c(), (int) O, (int) P, width, list);
            } else {
                float f3 = uwVar.getRevealInfo().c;
                Animator a2 = rw.a(uwVar, O, P, width);
                int i = (int) O;
                int i2 = (int) P;
    ...
    public final void Z(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofInt;
        if ((view2 instanceof uw) && (view instanceof ImageView)) {
            uw uwVar = (uw) view2;
            ...
            if (z) {
                ...
                ofInt = ObjectAnimator.ofInt(drawable, xv.b, 0);
            } else {
                ofInt = ObjectAnimator.ofInt(drawable, xv.b, 255);
            }
            ofInt.addUpdateListener(new b(this, view2));
            eVar.a.e("iconFade").a(ofInt);
            list.add(ofInt);
            list2.add(new c(this, uwVar, drawable));
        }
    }
    ...
    public final void c0(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        if (z) {
            ...
            L(view2, eVar, bwVar, bwVar2, -Q, -R, 0.0f, 0.0f, rectF);
        } else {
