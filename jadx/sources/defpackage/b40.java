...
public final class b40 {
    ...
    public static final int[] c = new int[Barcode.QR_CODE];
    ...
    public static String a(CharSequence charSequence, int i) {
        ...
        throw new IllegalArgumentException(C0059ao.a(2820).concat(String.valueOf(i)));
    }

    public static String b(String str, d40 d40Var) {
        if (str.length() == d40Var.a()) {
            StringBuilder sb = new StringBuilder(d40Var.a() + d40Var.c());
            sb.append(str);
            int f = d40Var.f();
            if (f == 1) {
                sb.append(a(str, d40Var.c()));
            } else {
                ...
                for (int i3 = 0; i3 < f; i3++) {
                    ...
                    for (int i4 = i3; i4 < d40Var.a(); i4 += f) {
                    ...
                    int i6 = i3;
                    while (i6 < iArr2[i3] * f) {
                        sb.setCharAt(d40Var.a() + i6, a2.charAt(i5));
                        i6 += f;
                        i5++;
                    }
                }
        ...
        throw new IllegalArgumentException(C0059ao.a(2821));
    }
}
