...
public class n4 extends Drawable {
    ...
    public n4(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.m = resources.getColor(d4.cardview_shadow_start_color);
        this.n = resources.getColor(d4.cardview_shadow_end_color);
        this.a = resources.getDimensionPixelSize(e4.cardview_compat_inset_shadow);
        n(colorStateList);
    ...
    public void p(float f) {
        ...
        throw new IllegalArgumentException(C0059ao.a(12478) + f + C0059ao.a(12479));
    }
    ...
    public final void s(float f, float f2) {
        ...
        String a2 = C0059ao.a(12480);
        if (i < 0) {
            throw new IllegalArgumentException(C0059ao.a(12482) + f + a2);
        } else if (f2 >= 0.0f) {
            float t = t(f);
            float t2 = t(f2);
            if (t > t2) {
            ...
            throw new IllegalArgumentException(C0059ao.a(12481) + f2 + a2);
        }
    }
