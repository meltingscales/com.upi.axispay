...
public class l1 extends e1 implements MenuItem {
    public final w9 d;
    public Method e;
    ...
    public class a extends fb {
        ...
        public void g(SubMenu subMenu) {
            this.c.onPrepareSubMenu(l1.this.d(subMenu));
        }
    }
    ...
    public class b extends a implements ActionProvider.VisibilityListener {
        ...
        public b(l1 l1Var, Context context, ActionProvider actionProvider) {
    ...
    /* renamed from: l1$c */
    /* loaded from: classes.dex */
    public static class c extends FrameLayout implements v0 {
    ...
    public class d implements MenuItem.OnActionExpandListener {
        ...
        public boolean onMenuItemActionCollapse(MenuItem menuItem) {
            return this.a.onMenuItemActionCollapse(l1.this.c(menuItem));
        }

        @Override // android.view.MenuItem.OnActionExpandListener
        public boolean onMenuItemActionExpand(MenuItem menuItem) {
            return this.a.onMenuItemActionExpand(l1.this.c(menuItem));
        }
    }
    ...
    public class e implements MenuItem.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            return this.a.onMenuItemClick(l1.this.c(menuItem));
        }
    }

    public l1(Context context, w9 w9Var) {
        super(context);
        if (w9Var != null) {
            this.d = w9Var;
            return;
        }
        throw new IllegalArgumentException(C0059ao.a(10008));
    }
    ...
    public void h(boolean z) {
        try {
            if (this.e == null) {
                this.e = this.d.getClass().getDeclaredMethod(C0059ao.a(10009), Boolean.TYPE);
            }
            this.e.invoke(this.d, Boolean.valueOf(z));
        } catch (Exception e2) {
            Log.w(C0059ao.a(10010), C0059ao.a(10011), e2);
        }
    }
    ...
    public MenuItem setActionProvider(ActionProvider actionProvider) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            aVar = new b(this, this.a, actionProvider);
        } else {
