...
public final class lg {
    ...
    public static final int mr_cast_group_volume_seekbar_height = 0;
    public static final int mr_cast_meta_art_size = 0;
    public static final int mr_cast_meta_subtitle_text_size = 0;
    public static final int mr_cast_route_volume_seekbar_height = 0;
    public static final int mr_cast_seekbar_thumb_size = 0;
    public static final int mr_controller_volume_group_list_item_height = 0;
    public static final int mr_controller_volume_group_list_item_icon_size = 0;
    public static final int mr_controller_volume_group_list_max_height = 0;
    public static final int mr_controller_volume_group_list_padding_top = 0;
    public static final int mr_dialog_fixed_width_major = 0;
    public static final int mr_dialog_fixed_width_minor = 0;
    public static final int mr_dynamic_dialog_header_text_size = 0;
    public static final int mr_dynamic_dialog_route_text_size = 0;
    public static final int mr_dynamic_dialog_row_height = 0;
    public static final int mr_dynamic_volume_group_list_item_height = 0;
