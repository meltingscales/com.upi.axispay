...
public class e90 extends BaseAdapter {
    ...
    public e90(Activity activity, ArrayList<Account> arrayList) {
        this.b = activity;
        c(arrayList);
    ...
    public void c(ArrayList<Account> arrayList) {
        ...
        account.setMaskedAccnumber(this.b.getResources().getString(R.string.select_account));
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        aVar.a.setText(this.c.get(i).getMaskedAccnumber());
        return view;
    }
}
