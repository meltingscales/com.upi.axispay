...
public abstract class w40 extends t40 {
    ...
    public static boolean a(CharSequence charSequence) throws z20 {
    ...
    public static int b(CharSequence charSequence) throws z20 {
        int length = charSequence.length();
        int i = 0;
