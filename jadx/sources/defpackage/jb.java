...
public class jb {
    ...
    static {
        C0059ao.a(jb.class, 225);
    }

    public static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!a) {
            try {
                b = actionBar.getClass().getMethod(C0059ao.a(9718), KeyEvent.class);
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return (view != null && ac.i(view, keyEvent)) || aVar.g(keyEvent);
    }

    public static DialogInterface.OnKeyListener f(Dialog dialog) {
        if (!c) {
            try {
                Field declaredField = Dialog.class.getDeclaredField(C0059ao.a(9719));
                d = declaredField;
