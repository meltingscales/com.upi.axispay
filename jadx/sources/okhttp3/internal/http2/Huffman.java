...
public final class Huffman {
    ...
    private final void addCode(int i, int i2, int i3) {
        ...
        yl0.c(children2);
        wi0.h(children2, node, i6, (1 << i5) + i6);
    }

    public final void decode(BufferedSource bufferedSource, long j, BufferedSink bufferedSink) {
        yl0.e(bufferedSource, C0059ao.a(1601));
        yl0.e(bufferedSink, C0059ao.a(1602));
        Node node = root;
        int i = 0;
        int i2 = 0;
    ...
    public final void encode(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        yl0.e(byteString, C0059ao.a(1603));
        yl0.e(bufferedSink, C0059ao.a(1604));
    ...
    public final int encodedLength(ByteString byteString) {
        yl0.e(byteString, C0059ao.a(1605));
        int size = byteString.size();
        long j = 0;
    ...
    public static final class Node {
        ...
        public Node() {
            this.children = new Node[Barcode.QR_CODE];
            this.symbol = 0;
