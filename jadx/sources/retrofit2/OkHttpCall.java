...
public final class OkHttpCall<T> implements Call<T> {
    ...
    public static final class NoContentResponseBody extends ResponseBody {
        ...
        @Override // okhttp3.ResponseBody
        public BufferedSource source() {
            throw new IllegalStateException(C0059ao.a(4658));
        }
    }
    ...
    private okhttp3.Call createRawCall() throws IOException {
        ...
        Objects.requireNonNull(newCall, C0059ao.a(1086));
        return newCall;
    }
    ...
    public void enqueue(final Callback<T> callback) {
        okhttp3.Call call;
        Throwable th;
        Objects.requireNonNull(callback, C0059ao.a(1087));
        synchronized (this) {
            if (!this.executed) {
                this.executed = true;
                call = this.rawCall;
                ...
                throw new IllegalStateException(C0059ao.a(1088));
            }
        }
        if (th != null) {
    ...
    public Response<T> execute() throws IOException {
        ...
        synchronized (this) {
            if (!this.executed) {
                ...
                throw new IllegalStateException(C0059ao.a(1089));
            }
        }
        if (this.canceled) {
            rawCall.cancel();
    ...
    public synchronized Request request() {
        try {
            ...
            throw new RuntimeException(C0059ao.a(1090), e);
        }
    ...
    public synchronized Timeout timeout() {
        try {
            ...
            throw new RuntimeException(C0059ao.a(1091), e);
        }
    ...
    @Override // retrofit2.Call
    /* renamed from: clone */
    public OkHttpCall<T> mo397clone() {
