...
public final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return Utils.typeToString(this.componentType) + C0059ao.a(3075);
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public ParameterizedTypeImpl(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            for (Type type3 : typeArr) {
                Objects.requireNonNull(type3, C0059ao.a(14720));
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                return C0059ao.a(9813) + Utils.typeToString(this.lowerBound);
            } else if (this.upperBound == Object.class) {
                return C0059ao.a(9814);
            } else {
                return C0059ao.a(9815) + Utils.typeToString(this.upperBound);
            }
        }
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        throw new IllegalArgumentException(C0059ao.a(4215) + i + C0059ao.a(4216) + actualTypeArguments.length + C0059ao.a(4217) + parameterizedType);
    }

    public static Class<?> getRawType(Type type) {
        Objects.requireNonNull(type, C0059ao.a(4218));
        if (type instanceof Class) {
            return (Class) type;
        }
        if (type instanceof ParameterizedType) {
            ...
            throw new IllegalArgumentException(C0059ao.a(4219) + type + C0059ao.a(4220) + type.getClass().getName());
        }
    }
    ...
    public static boolean hasUnresolvableType(@Nullable Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            throw new IllegalArgumentException(C0059ao.a(4222) + type + C0059ao.a(4223) + (type == null ? C0059ao.a(4221) : type.getClass().getName()));
        }
    }
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        return methodError(method, th, str + C0059ao.a(4228) + (i + 1) + C0059ao.a(4229), objArr);
    }
    ...
    */
    ...
    public static RuntimeException methodError(Method method, @Nullable Throwable th, String str, Object... objArr) {
        ...
        return new IllegalArgumentException(format + C0059ao.a(4224) + method.getDeclaringClass().getSimpleName() + C0059ao.a(4225) + method.getName(), th);
    }

    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        return methodError(method, str + C0059ao.a(4226) + (i + 1) + C0059ao.a(4227), objArr);
    }
}
